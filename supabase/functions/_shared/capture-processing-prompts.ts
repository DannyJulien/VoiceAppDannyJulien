...
- location: return a concise human-readable place only when the user explicitly named a meaningful location, venue, address, or remote meeting place. Preserve the level of specificity they gave (for example, "Brussels Central" or "Delhaize in Mechelen"); never invent an address, city, country, or place from context. Use null when no clear location was stated or the place is ambiguous.
