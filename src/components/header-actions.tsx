...
const createStyles = (colors: AppColors) =>
  StyleSheet.create({
    ...
    accountInitial: { color: colors.onBrand, fontSize: 15, fontWeight: '900' },
    pressed: { opacity: 0.8 },
    inboxIcon: { color: colors.brand, fontSize: 16, fontWeight: '900' },
    inboxLabel: { color: colors.ink, fontSize: 13, fontWeight: '900' },
    badge: {
      alignItems: 'center',
    ...
    badgeText: { color: colors.onBrand, fontSize: 10, fontWeight: '900', lineHeight: 14 },
  });
