...
export default function HomeScreen() {
  ...
  return (
    <Screen contentStyle={styles.content}>
      <ScrollView
        contentContainerStyle={[styles.scrollContent, tabBarInset]}
...
const createStyles = (colors: AppColors) =>
  StyleSheet.create({
    ...
    eyebrow: { color: colors.onBrandMuted, fontSize: 12, fontWeight: '900', letterSpacing: 1.25 },
    title: {
    ...
    micStem: { backgroundColor: colors.onBrand, borderRadius: 12, height: 33, width: 22 },
    micBase: {
      borderBottomWidth: 4,
      borderColor: colors.onBrand,
      borderLeftWidth: 4,
    ...
    stopIcon: { backgroundColor: colors.onBrand, borderRadius: 7, height: 30, width: 30 },
    captureStatus: { color: colors.onBrand, fontSize: 15, fontWeight: '800' },
    liveRow: { alignItems: 'center', flexDirection: 'row', gap: 7, maxWidth: 300 },
    liveDot: { backgroundColor: colors.accent, borderRadius: 5, height: 8, width: 8 },
    liveText: { color: colors.onBrandMuted, flex: 1, fontSize: 12, lineHeight: 17 },
